                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <form class="form-horizontal" action="{{ route('result_b') }}" method="post"
            ...
            <tbody>
                @foreach ($get as $gt)
                    <tr>
                        ...
                        <td>@if (($gt->mat+ $gt->eng+ $gt->che + $gt->phy+ $gt->bio) /5 > 60)
                            ...
                            <div class="modal fade" id="mymodal2{{ $gt->id }}" role="dialog">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <form class="form-horizontal" action="{{ route("update", $gt->id) }}" method="post"
                                                    enctype="multipart/form-data">
                                                    @csrf
                                                    @method("PATCH")
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-2" for="mat">Maths:</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="mat" id="mat" value="{{ $gt->mat }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-2" for="eng">English:</label>
                                                        <div class="col-sm-10">
                                                            <input type="number" class="form-control" name="eng" id="eng" value="{{ $gt->eng }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-2" for="che">Chemistry: </label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="che" id="che" value="{{ $gt->che }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-2" for="phy">Physics: </label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="phy" id="phy" value="{{ $gt->phy }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-2" for="bio">Biology: </label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="bio" id="bio" value="{{ $gt->bio }}">
                                                        </div>
                                                    </div>
